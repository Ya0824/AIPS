...
Input:
- Large VCD file containing multiple stimuli (e.g., `SwitchFile_train.vcd`)
Output:
- Aggregated switching activity array: `pin_switch_mean_train.npy`
...
Input:
- Power report file generated by PTPX (e.g., `PowerFile0_train.out`)
Output:
