...
class ParserVCD:
    ...
    def __init__(self) -> None:
        ...
        parser.add_argument('--pin_switch_pkl', default='./pin_switch_1/pin_switch')
...
def main():
    ...
    # Step 1
    parser.add_argument("--vcd_init_path", type=str, default="SwitchFile_train.vcd")
    ...
    # Step 3
    parser.add_argument('--pin_switch_folder', default='./pin_switch_1/')
    parser.add_argument('--output_npy', default='./pin_switch_mean.npy')
