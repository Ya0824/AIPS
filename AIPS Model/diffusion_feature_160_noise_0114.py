...
def load_and_flatten_features(feature_path):
    instance_feature = np.load(feature_path)
    flattened_feature = instance_feature.flatten().reshape(-1, 1131)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_path', type=str, default='../1-topology-analysis_result/instance_feature.npy')
    #parser.add_argument('--power_path', type=str, default='../3-VCD_parser/power_trace_train.npy')
    #parser.add_argument('--train_vcd_path', type=str, default='../3-VCD_parser/pin_switch_mean_160_train.npy')
    parser.add_argument('--predict_vcd_path', type=str, default='../TVLA/5000/pin_switch_4000_random.npy')
    parser.add_argument('--hidden_dim', type=int, default=48)
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--epochs', type=int, default=3000)
    parser.add_argument('--learning_rate', type=float, default=0.001)
    parser.add_argument('--noise_level', type=float, default=0.001)
    parser.add_argument('--output_path', type=str, default='power_trace_random_4000_pre.npy')
